...
const LandlordRegister = () => {
  ...
  const validateForm = () => {
    ...
    if (!documents.houseDocuments) newErrors.houseDocuments = 'House documents are required';
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log('Landlord registration data:', { formData, documents });
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-xl shadow-2xl p-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Landlord Registration</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className={`border-2 border-dashed rounded-lg p-6 text-center ${
                  errors.houseDocuments ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-green-400'
                }`}>
                  <input
                    type="file"
                  ...
                  <label htmlFor="houseDocuments" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      {documents.houseDocuments ? documents.houseDocuments.name : 'Click to upload house documents'}
                    </p>
                    <p className="text-xs text-gray-500">PDF, DOC, or images up to 10MB</p>
                  </label>
                </div>
                {errors.houseDocuments && <p className="mt-1 text-sm text-red-600">{errors.houseDocuments}</p>}
              </div>
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-lg p-6 text-center ${
                  errors.proofOfAddress ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-green-400'
                }`}>
                  <input
                    type="file"
                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                  ...
                  <label htmlFor="proofOfAddress" className="cursor-pointer">
                    ...
                    <p className="text-xs text-gray-500">Utility bill, bank statement, or government ID</p>
                  </label>
                </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/landlord-login" className="font-medium text-green-600 hover:text-green-500">
                Sign in here
              </Link>
            </p>
          </div>
