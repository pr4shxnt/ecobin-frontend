...
const TenantLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log('Tenant login data:', formData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-xl shadow-2xl p-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Tenant Login</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link to="/tenant-forgot-password" className="font-medium text-blue-600 hover:text-blue-500">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/tenant-register" className="font-medium text-blue-600 hover:text-blue-500">
                Register here
              </Link>
            </p>
          </div>
