...
const TenantRegister = () => {
  ...
  const validateForm = () => {
    ...
    if (!documents.rentalAgreement) newErrors.rentalAgreement = 'Rental agreement is required';
    if (!documents.photoIdentity) newErrors.photoIdentity = 'Photo identity proof is required';
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log('Tenant registration data:', { formData, documents });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-xl shadow-2xl p-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Tenant Registration</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className={`border-2 border-dashed rounded-lg p-6 text-center ${
                  errors.rentalAgreement ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-blue-400'
                }`}>
                  <input
                    type="file"
                  ...
                  <label htmlFor="rentalAgreement" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      {documents.rentalAgreement ? documents.rentalAgreement.name : 'Click to upload rental agreement'}
                    </p>
                    <p className="text-xs text-gray-500">PDF, DOC, or images up to 10MB</p>
                  </label>
                </div>
                {errors.rentalAgreement && <p className="mt-1 text-sm text-red-600">{errors.rentalAgreement}</p>}
              </div>
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-lg p-6 text-center ${
                  errors.photoIdentity ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-blue-400'
                }`}>
                  <input
                    type="file"
                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                  ...
                  <label htmlFor="photoIdentity" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      {documents.photoIdentity ? documents.photoIdentity.name : 'Click to upload photo identity proof'}
                    </p>
                    <p className="text-xs text-gray-500">Driver's license, passport, or government ID</p>
                  </label>
                </div>
                {errors.photoIdentity && <p className="mt-1 text-sm text-red-600">{errors.photoIdentity}</p>}
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/tenant-login" className="font-medium text-blue-600 hover:text-blue-500">
                Sign in here
              </Link>
            </p>
          </div>
